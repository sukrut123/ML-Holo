...
If[FileExistsQ["ml-test-datafile-"<>ToString[k]<>".dat"]==True,
kk =kk + 1;
loadrun["ml-test-datafile-"<>ToString[k]<>".dat"];
...
Put[{dt,Bfini,b0numlist,nz,t,tinitial,Bdtlist,Sdotlist,timelist,a3list,a3dtlist,b3list,b3dtlist,constrlist,Alist,Blist,Slist,Reverse[zEHlist][[;;,2]],zAHList[[;;,2]],Reverse[SEHlistcorrected][[;;,2]],SAHlistcorrected[[;;,2]]},"ml-data-pp-long-"<>ToString[kk]<>".dat"];
(*Print["kk="<>ToString[kk]];
Print["k="<>ToString[k]];*)],{k,1,10000}];
